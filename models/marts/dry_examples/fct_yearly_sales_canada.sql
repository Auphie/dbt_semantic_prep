...
final AS (
    ...
    SELECT
        ...
        order_id_count AS yearly_total_ca_orders,
        customer_id_count AS yearly_unique_ca_customers,
        order_amount AS yearly_total_ca_sales,
        gross_profit AS yearly_total_ca_gross_profit

    FROM ca_yearly_sales
