...
final AS (
    ...
    SELECT
        ...
        order_id_count AS daily_total_ca_orders,
        customer_id_count AS daily_unique_ca_customers,
        order_amount AS daily_total_ca_sales,
        gross_profit AS daily_total_ca_gross_profit
